...
pod 'SSZipArchive', :podspec => File.expand_path('./Pods/SSZipArchive/SSZipArchive.podspec')
pod 'MedianIcons', :podspec => File.expand_path('./Pods/MedianIcons/MedianIcons.podspec')
